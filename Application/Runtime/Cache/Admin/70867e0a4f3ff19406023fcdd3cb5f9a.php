...
<!--                 <select class="form-select-small">
                ...
                <a class="form-button color-bg-yellow" href="<?php echo U('UserAdmin/add');?>" target="main">添加</a>
			</div>
            </form>
		</div>
	</div>
	...
	<div class="table-list">
		<table cellpadding="0" cellspacing="0">
			...
			<?php if(is_array($UserAdmin)): $i = 0; $__LIST__ = $UserAdmin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td>
					<div>
						<a href="<?php echo U('UserAdmin/edit',array('id'=>$vo['id']));?>">
							<button class="form-button color-bg-green">修改密码</button>
						</a>
						<a href="<?php echo U('UserAdmin/rule',array('id'=>$vo['id']));?>">
							<button class="form-button color-bg-green">修改角色</button>
						</a>
						<a href="<?php echo U('UserAdmin/delete',array('id'=>$vo['id']));?>">
        ...
        <?php if(empty($UserAdmin)): ?><div class="nodata"><i class="iconfont">&#xe607;</i><span>没有查询到符合条件的记录</span></div><?php endif; ?>
