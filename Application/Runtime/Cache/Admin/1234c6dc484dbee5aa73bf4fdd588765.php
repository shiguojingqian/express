...
<div class="main">
	<div class="content">
		<div class="head-content">
			<div class="head-title">服务网点</div>
            <form action="<?php echo U('Dot/index');?>" method="GET">
...
<!--                 <select class="form-select-small">
                ...
                <a class="form-button color-bg-yellow" href="<?php echo U('Dot/add');?>" target="main">添加</a>
			</div>
            </form>
		</div>
	</div>
	...
	<div class="table-list">
		<table cellpadding="0" cellspacing="0">
			...
			<?php if(is_array($DotList)): $i = 0; $__LIST__ = $DotList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				<td><?php echo ($vo["dot_name"]); ?></td>
				...
				<td>
					<div>
						<a href="<?php echo U('Dot/edit',array('id'=>$vo['id']));?>">
							<button class="form-button color-bg-green">修改</button>
						</a>
						<a href="<?php echo U('Dot/delete',array('id'=>$vo['id']));?>">
        ...
        <?php if(empty($DotList)): ?><div class="nodata"><i class="iconfont">&#xe607;</i><span>没有查询到符合条件的记录</span></div><?php endif; ?>
