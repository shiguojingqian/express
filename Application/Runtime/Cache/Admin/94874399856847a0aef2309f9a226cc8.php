...
<div class="main FromUpToDown">
	<div class="content">
		...
		<div class="form-content">
			<div class="form">
				<div class="form-left">起步价</div>
				<div class="form-right">
					<input class="form-input-big" name="price" type="text" placeholder="请填写" value="<?php echo ($SettingInfo["price"]); ?>" />
					<div class="notice">这里填写起步价</div>
				</div>
			</div>

			<div class="form">
				<div class="form-left">专单价</div>
				<div class="form-right">
					<input class="form-input-big" name="vip" type="text" placeholder="请填写" value="<?php echo ($SettingInfo["vip"]); ?>"/>
					<div class="notice">这里填写专单价</div>
				</div>
			</div>
            <?php if($_GET['status'] == 3 or $_GET['status'] == 2): ?><div class="form">
				<div class="form-left">每公里计费</div>
				<div class="form-right">
					<input class="form-input-big" name="kilometre" type="text" placeholder="请填写" value="<?php echo ($SettingInfo["kilometre"]); ?>"/>
					<div class="notice">这里填写每公里费用</div>
				</div>
			</div><?php endif; ?>
