...
<div class="main">
	<div class="content">
		<div class="head-content">
			<div class="head-title">奖励设置</div>
			<div class="head-search">
                <a class="form-button color-bg-yellow" href="<?php echo U('Setting/rewardadd');?>" target="main">添加</a>
			</div>
		</div>
	</div>
	...
	<div class="table-list">
		<table cellpadding="0" cellspacing="0">
			...
			<?php if(is_array($RewardInfo)): $i = 0; $__LIST__ = $RewardInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				<td><?php echo ($vo["condition"]); ?>/件</td>
				<td><?php echo ($vo["price"]); ?></td>
				<td>
					<div>
						<a href="<?php echo U('Setting/rewardedit',array('id'=>$vo['id']));?>">
        ...
        <?php if(empty($RewardInfo)): ?><div class="nodata"><i class="iconfont">&#xe607;</i><span>没有查询到符合条件的记录</span></div><?php endif; ?>
